	...
	\end{itemize}      
      \end{frame}
       ...
       \begin{frame}{How To Solve This?}
			...
			\item Automate everything possible and have it ready like you were submitting a replication package tomorrow.
			\item Replicate everything and test whether it works (ideally let co-authors do that).
		\end{itemize}
       \end{frame}
